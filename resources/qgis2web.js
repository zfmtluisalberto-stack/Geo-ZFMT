...
function exportSelectedPlanPDF(title) {
    ...
    showGoogleSatelliteForExport(function(previousVisibility) {
        getMapCanvasDataURL(function(imgData) {
            if (satelliteLayer && previousVisibility !== null) {
                satelliteLayer.setVisible(previousVisibility);
            }
            ...
            if (!imgData) {
                ...
                fallbackNote = 'Mapa base no disponible, se generó solo la geometría.';
            }
...
function zoomToSearchFeature(feature, layer) {
    ...
    if (geometry.getType() === 'Point' || geometry.getType() === 'MultiPoint') {
        ...
        view.fit(geometry.getExtent(), { size: map.getSize(), padding: [80, 80, 80, 80], maxZoom: 18, duration: 700 });
    }
}
