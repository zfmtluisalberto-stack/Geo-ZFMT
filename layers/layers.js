...
var features_OcupantesirregularesZFMT_1 = format_OcupantesirregularesZFMT_1.readFeatures(json_OcupantesirregularesZFMT_1, 
            {dataProjection: 'EPSG:32612', featureProjection: 'EPSG:3857'});
...
var format_RecintosPortuarios_7 = new ol.format.GeoJSON();
var features_RecintosPortuarios_7 = format_RecintosPortuarios_7.readFeatures(json_RecintosPortuarios_7, 
            {dataProjection: 'EPSG:32612', featureProjection: 'EPSG:3857'});
var jsonSource_RecintosPortuarios_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RecintosPortuarios_7.addFeatures(features_RecintosPortuarios_7);
var lyr_RecintosPortuarios_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RecintosPortuarios_7, 
                style: style_RecintosPortuarios_7,
                popuplayertitle: 'Recintos portuarios',
                interactive: true,
                title: 'Recintos portuarios'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_OcupantesirregularesZFMT_1.setVisible(true);lyr_DesincorporacionesDGZFMT_2.setVisible(true);lyr_AcuerdosDestinoDGZMT_3.setVisible(true);lyr_ConcesionesDGZFMT_4.setVisible(true);lyr_DelimitacionesDGZFMT_5.setVisible(true);lyr_Cuadriculaestrategicazonificada_6.setVisible(true);lyr_RecintosPortuarios_7.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OcupantesirregularesZFMT_1,lyr_DesincorporacionesDGZFMT_2,lyr_AcuerdosDestinoDGZMT_3,lyr_ConcesionesDGZFMT_4,lyr_DelimitacionesDGZFMT_5,lyr_Cuadriculaestrategicazonificada_6,lyr_RecintosPortuarios_7];
lyr_OcupantesirregularesZFMT_1.set('fieldAliases', {'fid': 'fid', 'Clave': 'Clave', 'ID': 'ID', 'NOMBRE DEL OCUPANTE IRREGULAR': 'NOMBRE DEL OCUPANTE IRREGULAR', 'ID-OCUPACION': 'ID-OCUPACION', 'ID - Actualizado': 'ID - Actualizado', 'ZONA': 'ZONA', 'X': 'X', 'Y': 'Y', 'TIPO DE USO': 'TIPO DE USO', 'ZF': 'ZF', 'TGM': 'TGM', 'TOTAL': 'TOTAL', 'TIPO DE USO APLICABLE': 'TIPO DE USO APLICABLE', 'TARIFA ANUAL': 'TARIFA ANUAL', 'IMPORTE BIMESTRAL': 'IMPORTE BIMESTRAL', 'DEBE DESDE': 'DEBE DESDE', 'DEBE HASTA': 'DEBE HASTA', 'OBSERVACIONES': 'OBSERVACIONES', });
...
lyr_RecintosPortuarios_7.set('fieldAliases', {'Layer': 'Layer', 'PaperSpace': 'PaperSpace', 'SubClasses': 'SubClasses', 'Linetype': 'Linetype', 'EntityHand': 'EntityHand', 'Text': 'Text', 'developer': 'developer', });
lyr_OcupantesirregularesZFMT_1.set('fieldImages', {'fid': '', 'Clave': '', 'ID': '', 'NOMBRE DEL OCUPANTE IRREGULAR': '', 'ID-OCUPACION': '', 'ID - Actualizado': '', 'ZONA': '', 'X': '', 'Y': '', 'TIPO DE USO': '', 'ZF': '', 'TGM': '', 'TOTAL': '', 'TIPO DE USO APLICABLE': '', 'TARIFA ANUAL': '', 'IMPORTE BIMESTRAL': '', 'DEBE DESDE': '', 'DEBE HASTA': '', 'OBSERVACIONES': '', });
...
lyr_OcupantesirregularesZFMT_1.set('fieldLabels', {'fid': 'hidden field', 'Clave': 'inline label - always visible', 'ID': 'hidden field', 'NOMBRE DEL OCUPANTE IRREGULAR': 'inline label - always visible', 'ID-OCUPACION': 'inline label - always visible', 'ID - Actualizado': 'hidden field', 'ZONA': 'inline label - always visible', 'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'TIPO DE USO': 'inline label - always visible', 'ZF': 'inline label - always visible', 'TGM': 'inline label - always visible', 'TOTAL': 'inline label - always visible', 'TIPO DE USO APLICABLE': 'hidden field', 'TARIFA ANUAL': 'hidden field', 'IMPORTE BIMESTRAL': 'hidden field', 'DEBE DESDE': 'hidden field', 'DEBE HASTA': 'hidden field', 'OBSERVACIONES': 'hidden field', });
